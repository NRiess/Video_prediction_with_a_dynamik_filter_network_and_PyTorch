...
class DataHandler(object):
  ...
  def __init__(self, image_size=64, binarize=False, num_frames=20, batch_size=2, mode='train'):
    if mode == 'train':
      dataset = '/home/rns4fe/Documents/highway/highwayDriving_train.h5'
    elif mode == 'test':
      dataset = '/home/rns4fe/Documents/highway/highwayDriving_test.h5'
    ...
    self.data_ = f['highway_L'][()].transpose(0,1,3,2)
